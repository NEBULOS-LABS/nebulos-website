    ...
    <div ref={containerRef} className="relative min-h-[90vh] bg-transparent flex flex-col items-center justify-center pt-32 pb-20">
      <div className="relative z-10 mx-auto w-full px-4 sm:px-6 lg:px-8 mt-10">
          ...
          <p
            ...
            style={{ transform: "translateY(20px)" }}
          >
            We design, build, and scale revenueΓÇædriving productsΓÇöwebsites, SaaS
            platforms, mobile apps, and complex engineering systemsΓÇöusing elite
            talent, AIΓÇæaccelerated workflows, and a guarantee that puts all the
            risk on us.
          </p>
